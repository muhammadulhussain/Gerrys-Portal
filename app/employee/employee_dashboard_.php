...
include __DIR__ . '/../includes/layouts/sidebar.php';
...
<div class="main-content">
  ...
  <div class="position-absolute top-0 end-0 m-3 profile-container">
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end shadow p-3 animated-dropdown" aria-labelledby="profileDropdown">
        ...
        <li><a class="dropdown-item animated-item" href="index.php?page=account-detail"><i class="fa-solid fa-user me-2"></i> Account Details</a></li>
        <li><a class="dropdown-item animated-item" href="index.php?page=change-password"><i class="fa-solid fa-gear me-2"></i> Change Password</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item text-danger animated-item" href="index.php?page=logout"><i class="fa-solid fa-right-from-bracket me-2"></i> Sign Out</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="cards-row mb-4">
    ...
    <!-- Customers Card -->
    <a href="index.php?page=customer-info&station_id=<?= urlencode($station_id) ?>" class="hover-card" data-aos="fade-up" data-aos-delay="50">
      <div class="card">
    ...
    <!-- Bandwidth Card -->
<a href="index.php?page=bandwidth-report" class="hover-card" data-aos="fade-up" data-aos-delay="120">
  <div class="card">
    <div class="muted">
      Bandwidth (<?= date('F Y') ?>)
    </div>
    ...
    <a href="index.php?page=cdn-report" class="hover-card" data-aos="fade-up" data-aos-delay="190">
      <div class="card">
...
<script>
    window.dashboardData = {
        monthlyCustomers: <?= json_encode(array_values($monthlyCustomers)) ?>,
        customerStatus: {
            active: <?= (int)$customerStatus['Active'] ?>,
            suspended: <?= (int)$customerStatus['Suspended'] ?>,
            tempOff: <?= (int)$customerStatus['Temp Off'] ?>,
            terminated: <?= (int)$customerStatus['Terminated'] ?>
        }
    };
</script>
<script src="/GERRYS_PROJECT/public/assets/js/admin.js"></script>
