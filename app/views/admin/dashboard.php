<?php
// Variables assumed from AdminController:
  ...
  <div class="position-absolute top-0 end-0 m-3 profile-container">
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end shadow p-3 animated-dropdown" aria-labelledby="profileDropdown">
        ...
        <!-- Only Admin: Create User -->
        <li><a class="dropdown-item animated-item text-success" href="<?= BASE_URL ?>/account/create_account.php"><i class="fa-solid fa-user-plus me-2"></i> Create New User</a></li>
        <li><hr class="dropdown-divider"></li>
